 ...
 */
template <int N>
void backtrace_create_alignment(
    std::list<char> *alignments,
    boost::unordered_map<Coord<N>, Node<N>> *ClosedList, int map_size,
    int thread_map[]) {
 ...
 */
template <int N> void backtrace_print_similarity(std::list<char> *alignments) {
  ...
  std::cout << "Similarity: " << std::fixed << std::setprecision(2) << percent
            << "%" << std::endl;
}
 ...
 */
template <int N> void backtrace_print_alignment(std::list<char> *alignments) {
 ...
 */
template <int N>
void backtrace_print_fasta_file(std::list<char> *alignments,
 ...
 */
template <int N>
void backtrace(boost::unordered_map<Coord<N>, Node<N>> *ClosedList,
